...
function Donate() {
    ...
    const renderContent = () => {
        ...
        if (donationCategory === 'DINHEIRO') {
                ...
                default:
                    return (
                        <div className="flex flex-col gap-10">
                             <h1 className="font-bold text-xl" style={{ color: "var(--title-color)" }}>Doação em Dinheiro</h1>
            ...
            return (
                <div className="flex flex-col gap-10">
                    <h1 className="font-bold text-xl capitalize" style={{ color: "var(--title-color)" }}>Doação de {donationCategory.toLowerCase()}</h1>
                    <p  style={{ color: "var(--text-color)" }}>Registre a doação feita pessoalmente na ONG.</p>
            ...
            <div className="flex-grow flex justify-center items-center p-4">
                <Card className="flex flex-col gap-10 p-5 bg-white max-w-[500px]">
                    <div className="flex flex-col gap-5">
                        <h1 className="font-bold text-xl" style={{ color: "var(--title-color)" }}>Faça sua doação</h1>
