  ...
  return (
    <>
      <div className="min-h-full">
        ...
        <section className="flex flex-col lg:flex-row items-center justify-between bg-gray-800 p-8 shadow-md max-w-6xl mx-auto gap-8 mt-6">
          <div className="lg:w-1/3">
            <h2 className="text-3xl font-bold text-emerald-700 mb-4">🐾 Sobre Nós</h2>
      ...
      <section className="mt-16 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-2xl font-bold text-emerald-700 mb-4">🌟 Junte-se à Nossa Causa</h2>
       ...
       <section className="bg-white py-12">
         <div className="max-w-6xl mx-auto px-4">
           <h2 className="text-3xl font-bold text-center mb-8 text-gray-800">Nosso Impacto</h2>
